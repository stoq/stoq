...
from stoq.lib.gui.base.gtkadds import change_button_appearance
from stoq.lib.gui.base.messagebar import MessageBar
from stoq.lib.gui.events import DialogCreateEvent, RunDialogEvent
...
class BasicDialog(GladeDelegate, RunnableView):
    ...
    def _create_dialog_ui(self):
        ...
        # FIXME
        # stoq/lib/gui/base/search.py - hides the header
        ...
        # FIXME
        # stoq/lib/gui/dialogs/importerdialog.py - setting
        # stoq/lib/gui/base/lists.py - removes the label
        # stoq/lib/gui/base/search.py - removes the label
