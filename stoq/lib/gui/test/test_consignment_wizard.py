...
from stoqlib.domain.product import (ProductStockItem,
                                    ...
                                    Storable)
from stoq.lib.gui.editors.purchaseeditor import InConsignmentItemEditor
from stoq.lib.gui.test.uitestutils import GUITest
from stoq.lib.gui.wizards.consignmentwizard import CloseInConsignmentWizard, ConsignmentWizard
from stoq.lib.gui.wizards.receivingwizard import ReceivingInvoiceStep
...
class TestConsignmentWizard(GUITest):
    ...
    @mock.patch('stoq.lib.gui.wizards.consignmentwizard.info')
    @mock.patch('stoq.lib.gui.wizards.consignmentwizard.run_dialog')
