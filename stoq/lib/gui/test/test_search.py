...
from stoq.lib.gui.events import SearchDialogSetupSearchEvent
...
from stoq.lib.gui.search.searchfilters import (StringSearchFilter, DateSearchFilter,
                                               ComboSearchFilter, NumberSearchFilter)
from stoq.lib.gui.search.searchoptions import (ThisWeek, LastWeek, NextWeek, ThisMonth,
                                               LastMonth, NextMonth)
...
class TestSearchEditor(GUITest):
    ...
    @mock.patch('stoq.lib.gui.search.searcheditor.api.new_store')
    @mock.patch('stoq.lib.gui.search.searcheditor.run_dialog')
...
class TestSearchGeneric(DomainTest):
    ...
    def _get_all_searches(cls):
        for klass in get_all_classes('stoq/lib/gui'):
            try:
