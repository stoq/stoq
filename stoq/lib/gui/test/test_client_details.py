...
class TestClientDetails(GUITest):
    ...
    @mock.patch('stoq.lib.gui.dialogs.clientdetails.run_person_role_dialog')
    def test_further_details(self, run_dialog):
        client = self.create_client()

        dialog = ClientDetailsDialog(self.store, client)
        new_store = 'stoq.lib.gui.dialogs.clientdetails.api.new_store'
    ...
    @mock.patch('stoq.lib.gui.dialogs.clientdetails.run_dialog')
    @mock.patch('stoq.lib.gui.dialogs.clientdetails.api.new_store')
    @mock.patch('stoq.lib.gui.slaves.saleslave.return_sale')
