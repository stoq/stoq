...
from stoq.lib.gui.editors.paymenteditor import LonelyPaymentDetailsDialog
...
class TestPaymentSearch(GUITest):
    ...
    @mock.patch('stoq.lib.gui.search.searchdialog.print_report')
    @mock.patch('stoq.lib.gui.search.paymentsearch.run_dialog')
