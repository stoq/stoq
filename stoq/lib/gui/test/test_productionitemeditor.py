...
from stoq.lib.gui.editors.productioneditor import ProductionItemEditor
from stoq.lib.gui.test.uitestutils import GUITest


class TestProductionItemEditor(GUITest):
    def test_show(self):
        production_item = self.create_production_item()
        editor = ProductionItemEditor(self.store, production_item)
