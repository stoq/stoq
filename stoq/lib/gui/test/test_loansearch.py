...
from stoq.lib.gui.search.loansearch import LoanSearch
...
class TestLoanSearch(GUITest):
    ...
    @mock.patch('stoq.lib.gui.search.loansearch.api.new_store')
    @mock.patch('stoq.lib.gui.search.loansearch.run_dialog')
    @mock.patch('stoq.lib.gui.search.loansearch.print_report')
