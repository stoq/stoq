...
from stoq.lib.gui.editors.clientcategoryeditor import ClientCategoryEditor
...
class TestClientCategoryDialog(GUITest):
    ...
    @mock.patch('stoq.lib.gui.base.lists.run_dialog')
    ...
    @mock.patch('stoq.lib.gui.dialogs.clientcategorydialog.warning')
