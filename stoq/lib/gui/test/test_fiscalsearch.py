...
from stoq.lib.gui.search.fiscalsearch import CfopSearch, FiscalBookEntrySearch, FiscalBookEntryType
...
class TestFiscalBookSearch(GUITest):
    ...
    @mock.patch('stoq.lib.gui.search.fiscalsearch.run_dialog')
