...
from stoq.lib.gui.wizards.salequotewizard import SaleQuoteWizard, DiscountEditor
...
class TestSaleQuoteWizard(GUITest):
    @mock.patch('stoq.lib.gui.wizards.salequotewizard.yesno')
    ...
    def test_add_package_product(self):
        ...
        klist.select(klist[0])
        with mock.patch('stoq.lib.gui.base.lists.yesno') as yesno:
    ...
    @mock.patch('stoq.lib.gui.wizards.salequotewizard.localtoday')
