...
from stoqlib.domain.person import (Client, Employee, EmployeeRoleHistory, Supplier,
                                   Transporter, EmployeeRole)
...
from stoq.lib.gui.search.personsearch import (ClientSearch, EmployeeSearch,
