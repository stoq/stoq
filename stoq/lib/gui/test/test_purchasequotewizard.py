...
class TestQuotePurchaseeWizard(GUITest):
    ...
    def test_create(self, delete, commit):
        ...
        patch = 'stoq.lib.gui.wizards.purchasequotewizard.run_dialog'
        ...
        patch = 'stoq.lib.gui.wizards.purchasequotewizard.print_report'
...
class TestReceiveQuoteWizard(GUITest):
    ...
    @mock.patch('stoq.lib.gui.wizards.purchasequotewizard.run_dialog')
    @mock.patch('stoq.lib.gui.wizards.purchasequotewizard.yesno')
    def test_create(self, yesno, run_dialog):
        ...
        item_step = self.wizard.get_current_step()
        new_store = 'stoq.lib.gui.wizards.purchasequotewizard.api.new_store'
