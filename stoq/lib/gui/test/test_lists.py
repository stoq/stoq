...
"""Tests for :mod:`stoq.lib.gui.base.lists`"""
...
from stoq.lib.gui.base.lists import ModelListSlave, SimpleListDialog
...
class TestModelListSlave(GUITest):
    """Tests for :class:`stoq.lib.gui.base.lists.ModelListSlave`"""
...
class TestSimpleListDialog(GUITest):
    """Tests for :class:`stoq.lib.gui.base.lists.SimpleListDialog`"""
