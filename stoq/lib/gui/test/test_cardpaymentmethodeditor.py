...
from stoq.lib.gui.editors.paymentmethodeditor import (CardDeviceEditor,
                                                      CardDeviceListSlave,
...
class TestProviderListSlave(GUITest):
    ...
    @mock.patch('stoq.lib.gui.editors.paymentmethodeditor.info')
    @mock.patch('stoq.lib.gui.editors.paymentmethodeditor.yesno')
