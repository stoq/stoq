...
class TestProductionQuoteDialog(GUITest):
    @mock.patch('stoq.lib.gui.dialogs.productionquotedialog.info')
    @mock.patch('stoq.lib.gui.dialogs.productionquotedialog.api.get_current_user')
    @mock.patch('stoq.lib.gui.dialogs.productionquotedialog.api.new_store')
