...
class TestStockTransferWizard(GUITest):
    @mock.patch('stoq.lib.gui.wizards.stocktransferwizard.print_report')
    @mock.patch('stoq.lib.gui.wizards.stocktransferwizard.yesno')
    def test_create(self, yesno, print_report):
        ...
        module = 'stoq.lib.gui.events.StockTransferWizardFinishEvent.emit'
