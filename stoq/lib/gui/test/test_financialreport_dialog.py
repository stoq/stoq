...
class TestFinancialReportDialog(GUITest):
    @mock.patch('stoq.lib.gui.dialogs.financialreportdialog.SpreadSheetExporter.export_temporary')
    @mock.patch('stoq.lib.gui.dialogs.financialreportdialog.localtoday')
