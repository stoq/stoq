...
class TestSaleDetails(GUITest):
    ...
    @mock.patch('stoq.lib.gui.dialogs.saledetails.print_report')
    ...
    @mock.patch('stoq.lib.gui.dialogs.saledetails.run_dialog')
    ...
    @mock.patch('stoq.lib.gui.dialogs.saledetails.BillReport.check_printable')
    @mock.patch('stoq.lib.gui.dialogs.saledetails.print_report')
