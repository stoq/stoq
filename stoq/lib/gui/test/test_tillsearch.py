...
from stoq.lib.gui.search.tillsearch import TillClosedSearch
from stoq.lib.gui.dialogs.tilldetails import TillDetailsDialog
...
class TestTillSearch(GUITest):
    ...
    def test_run_dialog(self):
        ...
        with mock.patch("stoq.lib.gui.search.tillsearch.run_dialog") as r_dialog:
