...
from stoq.lib.gui.editors.paymenteditor import (_ONCE, InPaymentEditor,
                                                OutPaymentEditor,
...
class TestPaymentEditor(GUITest):
    ...
    @mock.patch('stoq.lib.gui.editors.paymenteditor.get_current_branch')
    ...
    @mock.patch('stoq.lib.gui.editors.paymenteditor.run_dialog')
