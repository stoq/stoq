...
from stoq.lib.gui.editors.producteditor import (ProductPackageComponentEditor,
...
class TestProducCreateWizard(GUITest):
    ...
    @mock.patch('stoq.lib.gui.wizards.productwizard.warning')
    ...
    @mock.patch('stoq.lib.gui.slaves.productslave.warning')
    ...
    @mock.patch('stoq.lib.gui.slaves.productslave.run_dialog')
    ...
    @mock.patch('stoq.lib.gui.wizards.productwizard.yesno')
