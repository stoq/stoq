...
from stoq.lib.gui.base.wizards import BaseWizardStep
from stoq.lib.gui.slaves.workorderslave import WorkOrderQuoteSlave
from stoq.lib.gui.widgets.notebookbutton import NotebookCloseButton
from stoq.lib.gui.wizards.salequotewizard import (SaleQuoteWizard, StartSaleQuoteStep,
                                                  SaleQuoteItemStep)
...
class WorkOrderQuoteStartStep(StartSaleQuoteStep):
    ...
    Just like
    :class:`stoq.lib.gui.wizards.salequotewizard.StartSaleQuoteStep`,
...
class WorkOrderQuoteItemStep(SaleQuoteItemStep):
    ...
    Just like :class:`stoq.lib.gui.wizards.salequotewizard.SaleQuoteItemStep`,
