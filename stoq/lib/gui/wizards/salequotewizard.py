...
from stoq.lib.gui.editors.discounteditor import DiscountEditor
from stoq.lib.gui.editors.fiscaleditor import CfopEditor
from stoq.lib.gui.editors.noteeditor import NoteEditor
from stoq.lib.gui.events import (SaleQuoteWizardFinishEvent, SaleQuoteFinishPrintEvent,
                                 WizardAddSellableEvent, StockOperationPersonValidationEvent)
from stoq.lib.gui.editors.saleeditor import SaleQuoteItemEditor
...
class SaleQuoteItemStep(SellableItemStep):
    ...
    def _show_missing_details(self, button):
        from stoq.lib.gui.base.lists import SimpleListDialog
...
class SaleQuotePaymentStep(WizardEditorStep):
    ...
    :class:`stoq.lib.gui.slaves.paymentslave.MultipleMethodSlave`, so
