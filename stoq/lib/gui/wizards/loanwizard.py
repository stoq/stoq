...
from stoq.lib.gui.events import (NewLoanWizardFinishEvent,
                                 CloseLoanWizardFinishEvent,
                                 LoanItemSelectionStepEvent,
                                 InvoiceSetupEvent,
                                 WizardAddSellableEvent,
                                 StockOperationPersonValidationEvent)
from stoq.lib.gui.editors.loanitemeditor import LoanItemEditor
...
from stoq.lib.gui.wizards.salequotewizard import SaleQuoteItemStep
