...
from stoq.lib.gui.editors.productioneditor import ProductionItemEditor, ProductionServiceEditor
from stoq.lib.gui.slaves.productionslave import ProductionMaterialListSlave
