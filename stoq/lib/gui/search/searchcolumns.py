...
class SearchColumn(Column):
    ...
    :class:`stoq.lib.gui.search.searchslave.SearchSlave`
...
class IdentifierColumn(SearchColumn):
    ...
    This is :class:`stoq.lib.gui.search.searchcolumns.SearchColumn`, but
...
class QuantityColumn(SearchColumn):
    ...
    This is :class:`stoq.lib.gui.search.searchcolumns.SearchColumn`, but will
