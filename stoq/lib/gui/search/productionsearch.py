...
from stoq.lib.gui.editors.producteditor import ProductionProductEditor
from stoq.lib.gui.search.productsearch import ProductSearch, ProductSearchQuantity
