...
from stoq.lib.gui.search.searchcolumns import AccessorColumn, SearchColumn, QuantityColumn
...
class SellableSearch(SearchEditor):
    ...
    def on_branch_stock_button__clicked(self, widget):
        from stoq.lib.gui.search.productsearch import ProductBranchSearch
