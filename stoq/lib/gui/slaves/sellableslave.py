...
from stoq.lib.gui.editors.baseeditor import BaseRelationshipEditorSlave, BaseEditorSlave
from stoq.lib.gui.editors.sellableeditor import CategoryPriceEditor
