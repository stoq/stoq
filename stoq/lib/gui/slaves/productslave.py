...
from stoq.lib.gui.editors.baseeditor import BaseEditorSlave, BaseRelationshipEditorSlave
from stoq.lib.gui.editors.grideditor import GridAttributeEditor
from stoq.lib.gui.editors.producteditor import (TemporaryProductComponent,
                                                ProductComponentEditor,
                                                QualityTestEditor,
                                                ProductSupplierEditor,
                                                ProductPackageComponentEditor)
from stoq.lib.gui.fields import GridGroupField
