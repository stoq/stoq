...
from stoq.lib.gui.editors.paymentmethodeditor import PaymentMethodEditor, CardPaymentMethodEditor
from stoq.lib.gui.search.searcheditor import SearchEditorToolBar
