...
from stoq.lib.gui.base.dialogs import RunnableView, BasicDialog, run_dialog
from stoq.lib.gui.events import EditorSlaveCreateEvent, EditorSlaveConfirmEvent, EditorCreateEvent
...
class BaseEditorSlave(GladeSlaveDelegate):
    ...
    def on_cancel(self):
        ...
        Some places (like :func:`stoq.lib.gui.base.dialogs.run_dialog`) will
