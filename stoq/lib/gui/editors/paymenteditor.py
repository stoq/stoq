...
from stoq.lib.gui.dialogs.paymentdetails import LonelyPaymentDetailsDialog
from stoq.lib.gui.dialogs.purchasedetails import PurchaseDetailsDialog
from stoq.lib.gui.dialogs.renegotiationdetails import RenegotiationDetailsDialog
from stoq.lib.gui.dialogs.saledetails import SaleDetailsDialog
from stoq.lib.gui.editors.baseeditor import BaseEditor
from stoq.lib.gui.fields import (AttachmentField, PaymentCategoryField,
                                 PersonField, PaymentMethodField,
                                 PersonQueryField)
from stoqlib.lib.dateutils import (get_interval_type_items, interval_type_as_relativedelta,
                                   localtoday)
