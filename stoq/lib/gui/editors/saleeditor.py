...
from stoq.lib.gui.editors.baseeditor import BaseEditor, BaseEditorSlave
from stoq.lib.gui.editors.invoiceitemeditor import InvoiceItemEditor
from stoq.lib.gui.fields import PersonField, PersonQueryField, DateTextField
