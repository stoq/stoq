...
from stoq.lib.gui.editors.sellableeditor import SellableEditor
from stoq.lib.gui.slaves.imageslave import ImageGallerySlave
...
class ProductEditor(SellableEditor):
    ...
    def setup_slaves(self):
        ...
        from stoq.lib.gui.slaves.productslave import ProductInformationSlave
    ...
    def get_extra_tabs(self):
        from stoq.lib.gui.slaves.productslave import (ProductTaxSlave,
...
class ProductStockEditor(BaseEditor):
    ...
    def setup_slaves(self):
        ...
        from stoq.lib.gui.slaves.sellableslave import SellableDetailsSlave
