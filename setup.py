...
data_files = [
    ...
    ('$datadir/html', listfiles('data', 'html', 'js', 'fullcalendar-1.5.2', 'fullcalendar', '*.js')),
    ('$datadir/html', listfiles('data', 'html', 'js', 'fullcalendar-1.5.2', 'fullcalendar', '*.css')),
    ('$datadir/html', listfiles('data', 'html', 'js', 'fullcalendar-1.5.2', 'jquery', '*.js')),
    ('$datadir/html', listfiles('data', 'html', 'js', 'qtip', '*.js')),
    ('$datadir/html', listfiles('data', 'html', 'js', 'qtip', '*.css')),
    ('$sysconfdir/stoq',  ''),
