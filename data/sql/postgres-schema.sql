...
ALTER TABLE bill_p_m ALTER COLUMN id TYPE bigint;
ALTER TABLE card_p_m ALTER COLUMN id TYPE bigint;
ALTER TABLE check_p_m ALTER COLUMN id TYPE bigint;
ALTER TABLE finance_p_m ALTER COLUMN id TYPE bigint;
ALTER TABLE gift_certificate_p_m ALTER COLUMN id TYPE bigint;
ALTER TABLE money_p_m ALTER COLUMN id TYPE bigint;
