    ...
    IF FOUND THEN
        ...
        ELSIF NEW.quantity > 0 AND NEW.unit_cost IS NOT NULL THEN
            ...
            IF psi.quantity < 0 THEN
                -- If the old stock quantity is negative, we assume that this most recent cost
                -- update is the correct cost, since we cant be sure of how many items there
                -- are to reliably calculate the average cost.
