...
def register_iconsets():
    icon_info = [
        ("stoq-add",
         { gtk.ICON_SIZE_MENU: "add16px.png",
           gtk.ICON_SIZE_LARGE_TOOLBAR: "add24px.png",
           gtk.ICON_SIZE_DIALOG: "add48px.png" }),
        ("stoq-admin-app",
        ...
        ("stoq-deliveries",
         { gtk.ICON_SIZE_LARGE_TOOLBAR: "delivery24px.png" }),
        ("stoq-edit",
         { gtk.ICON_SIZE_MENU: "edit16px.png",
           gtk.ICON_SIZE_LARGE_TOOLBAR: "edit24px.png",
           gtk.ICON_SIZE_DIALOG: "edit48px.png" }),
        ("stoq-find",
         { gtk.ICON_SIZE_MENU: "kfind16px.png",
           gtk.ICON_SIZE_LARGE_TOOLBAR: "kfind22px.png" }),
        ("stoq-hr",
        ...
        ("stoq-remove",
         { gtk.ICON_SIZE_MENU: "remove16px.png",
           gtk.ICON_SIZE_LARGE_TOOLBAR: "remove24px.png",
           gtk.ICON_SIZE_DIALOG: "remove48px.png" }),
        ("stoq-sales-app",
