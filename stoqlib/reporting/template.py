...
##
"""
stoqlib/reporting/template.py:

    Este módulo implementa a classe BaseReportTemplate, onde todos os métodos
    para inserção de elementos no relatório estão definidos e, parcialmente,
    implementados.
"""
