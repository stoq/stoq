...
stoqlib/reporting/flowables.py:
    ...
    Este módulo disponibiliza novos elementos (flowables) de forma à
    permitir extender a funcionalidade do ReportLab. Os elementos referidos
    são PageNumberChanger, ReportLine e Signature.
