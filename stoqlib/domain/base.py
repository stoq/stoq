...
from stoqlib.database.orm import ORMObject, const
...
class BaseDomain(AbstractModel, ORMObject):
    ...
    def _check_unique_value_exists(self, attribute, value):
        ...
        # FIXME: We will do this by selectOneBy when we have a way
        #        to decide what to do with duplicated values.
        #        This is to avoid a traceback generated by it.
        for result in self.selectBy(**kwargs):
            # If there is any result other then self,
