...
class IInvoice(Interface):
    ...
    items = Attribute("Items used in the operation")
    ...
    coupon_id = Attribute("COO number of fiscal coupon")
    nfe_coupon_info = Attribute("ECF and COO number of fiscal coupon")
