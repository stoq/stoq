    ...
    def test_get_next_invoice_number(self):
        with mock.patch('stoqlib.lib.pluginmanager.PluginManager.is_active') as patch:
            ...
            with mock.patch(module) as emit:
                ...
                last_invoice_number = Invoice.get_last_invoice_number(self.store, Invoice.NFE_MODE)
                next_invoice_number = Invoice.get_next_invoice_number(self.store, Invoice.NFE_MODE)
