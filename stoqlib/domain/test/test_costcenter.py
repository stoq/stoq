...
class TestCostCenter(DomainTest):
    def test_add_transaction(self):
        ...
        self.assertEqual(entry[0].stock_transaction, stock_trans)
    ...
    def test_add_lonely_payment(self):
        ...
        entry = self.store.find(CostCenterEntry, payment=payment)
        self.assertEqual(len(list(entry)), 1)
        self.assertEqual(entry[0].payment, payment)
    ...
    def test_get_payment_entries(self):
        ...
        self.assertEqual(list(cost_center1.get_payment_entries()),
                         [cost_center_entry1, cost_center_entry2])
        self.assertEqual(list(cost_center2.get_payment_entries()),
                         [cost_center_entry3])
    ...
    def test_get_stock_transaction_entries(self):
        ...
        self.assertEqual(list(cost_center1.get_stock_transaction_entries()),
                         [cost_center_entry1, cost_center_entry2])
        self.assertEqual(list(cost_center2.get_stock_transaction_entries()),
                         [cost_center_entry3])
    ...
    def test_stock_decreases(self):
        ...
        self.assertEqual(results.one(), stock_decrease)
    ...
    def test_get_sales(self):
        ...
        self.assertEqual(set(cost_center1.get_sales()), set([sale1, sale2]))
        self.assertEqual(list(cost_center2.get_sales()), [sale3])
    ...
    def test_get_entries(self):
        ...
        self.assertEqual(list(cost_center1.get_entries()), [entry1, entry2])
        self.assertEqual(list(cost_center2.get_entries()), [entry3])
    ...
    def test_get_active(self):
        ...
        self.assertEqual([cost_center], list(cost_centers))
    ...
    def test_get_payments(self):
        ...
        self.assertEqual(results.one(), payment)
