...
Requires: pygtk2 >= 2.8.1, python-zope-interface >= 3.0.1, stoqdrivers >= 0.9.6, python-kiwi >= 1.9.24, python-psycopg2 >= 2.0.5, gazpacho >= 0.6.6, python-imaging >= 1.1.5, python-reportlab >= 1.20, python-dateutil >= 1.3
Requires: python-abi = %(%{__python} -c "import sys; print sys.version[:3]")
BuildRequires: python-kiwi >= 1.9.24, python-reportlab >= 1.20, python-psycopg2 >= 2.0.5, python-dateutil >= 1.3
BuildArch: noarch
